...
const Footer = () => {
  return (
    <footer className="bg-[#1A1A1A] text-white">
      <div className="w-full h-full mx-auto lg:px-12 sm:px-2 sm:py-6 py-12">
        <div className="px-12 sm:px-2 flex flex-row gap-24 sm:gap-4 mb-8">
          <div>
          ...
          <div className="flex flex-row text-3xl gap-32 sm:gap-4 mb-8">
            <div>
